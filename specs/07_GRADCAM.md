...
El umbral visual .5 se mantiene separado de `tau*`, que gobierna evaluación operativa. **GAP-F10-04** sólo cubre la selección histórica completa de ejemplos: una réplica debe declarar su propio criterio y no atribuirlo al estudio original.
